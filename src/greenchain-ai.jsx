...
const TR = {
  en: {
    appName: "GREENCHAIN",
    tagline: "Supply chains.",
    taglineGreen: "Decarbonized.",
    systemAccess: "System Access",
    gateway: "ZERO-TRUST ENTERPRISE GATEWAY",
    enterpriseId: "Enterprise ID",
    passkey: "Passkey",
    awaitHandshake: "Awaiting secure handshake...",
    initiateSession: "INITIATE SESSION",
    authenticating: "AUTHENTICATING...",
    sso: "SSO via Azure AD / Okta / SAML 2.0",
    devBypass: "⚙ DEV BYPASS",
    devMode: "DEVELOPER MODE · NOT FOR PRODUCTION",
    security: "AES-256 · TLS 1.3 · MFA ENFORCED · SOC 2 TYPE II",
    build: "GreenChain AI © 2025 · Build v4.12.3",
    ...
    system: "SYSTEM",
    commerce: "COMMERCE",
    navDashboard: "Command Matrix",
    navCompliance: "Compliance Core",
    navOptimizer: "Cost Optimizer",
    navSourcing: "Sourcing Grid",
    navReports: "AI Reports",
    navCredits: "Carbon Credits",
    navSettings: "Configuration",
    navExports: "Audit Exports",
    moduleUnderConstruction: "MODULE UNDER CONSTRUCTION",
    navigateTo:
      "Navigate to Dashboard, Optimizer, Sourcing Grid, AI Reports or Carbon Credits",
    initTelemetry: "Initializing telemetry matrix...",
    mod1eyebrow: "Module I · Live",
    mod1title: "Command Telemetry Matrix",
    mod1meta: "Last sync: 14 Jun 2026 · 09:42 UTC · 3 active leakage warnings",
    kpi1label: "Scope 1 Emissions",
    kpi1val: "12,480",
    kpi1unit: "tCO₂e",
    kpi1sub: "▼ 8.2% vs last quarter",
    kpi2label: "Carbon Tax Liability",
    kpi2val: "$284K",
    kpi2unit: "YTD",
    kpi2sub: "▲ 12% — EU CBAM update",
    kpi3label: "Cost Leakage Caught",
    kpi3val: "$1.4M",
    kpi3unit: "Recovered",
    kpi3sub: "▲ 23% vs last month",
    kpi4label: "Active Penalty Risk",
    kpi4val: "3",
    kpi4unit: "Exposures",
    kpi4sub: "Mexico · UK · Brazil",
    annualEmission: "Annual Emission Registry",
    systemAlerts: "System Alerts",
    criticalAlerts: "3 CRITICAL",
    complianceStatus: "Compliance Status — Regulatory Pipeline",
    activeItems: "5 ACTIVE",
    mod3eyebrow: "Module III",
    mod3title: "Cost Recovery & Leakage Optimizer",
    mod3meta:
      "Real-time factory floor monitoring · 14 active sensors · Last scan: 40s ago",
    commodityIndex: "Commodity Price Parity Index",
    greenCapital: "Green Capital Financing Gateway",
    pipeline: "$8.2M PIPELINE",
    application: "Application",
    mod4eyebrow: "Module IV",
    mod4title: "Sustainable Sourcing & Logistics Grid",
    mod4meta:
      "284 verified suppliers · 12 active contract negotiations · ECO-rated network",
    supplierMarket: "Supplier Marketplace — Recommended Vendors",
    ecoVerified: "ECO-VERIFIED",
    penaltyPredictor: "Penalty Predictor — Regulatory Risk Forecast",
    highRisk: "3 HIGH RISK",
    requestQuote: "Request Quote",
    penaltyProb: "PENALTY PROBABILITY",
    supplier: "Supplier",
    location: "Location",
    distance: "Distance",
    ...
    avgDelivery: "Avg. Delivery Distance",
    avgCarbon: "Avg. Carbon Rating",
    activeRfq: "Active RFQs",
    aiReportsEyebrow: "Module V · AI-Powered",
    aiReportsTitle: "Intelligent Report Generator",
    aiReportsMeta:
      "Claude AI · Instant regulatory & ESG reports · 40+ templates",
    ...
    reportPromptPh: "Describe your report requirements...",
    creditsEyebrow: "Module VI",
    creditsTitle: "Carbon Credits Trading Desk",
    creditsMeta: "EU ETS · Gold Standard · VCS · CDM · Live market prices",
    buyCredits: "Buy Credits",
    sellCredits: "Sell Credits",
    creditPrice: "Credit Price",
    creditVol: "24h Volume",
    yourPortfolio: "Your Portfolio",
    totalCredits: "Total Credits",
    portfolioVal: "Portfolio Value",
    offsetGoal: "Offset Goal",
    pricingTitle: "Enterprise Plans",
  ...
  ar: {
    appName: "جرين تشين",
    tagline: "سلاسل الإمداد.",
    taglineGreen: "خالية من الكربون.",
    systemAccess: "دخول النظام",
    gateway: "بوابة المؤسسة — الثقة الصفرية",
    enterpriseId: "معرف المؤسسة",
    passkey: "كلمة المرور",
    awaitHandshake: "في انتظار المصادقة الآمنة...",
    initiateSession: "بدء الجلسة",
    authenticating: "جارٍ المصادقة...",
    sso: "تسجيل الدخول عبر Azure AD / Okta / SAML 2.0",
    devBypass: "⚙ دخول المطور",
    devMode: "وضع المطور · غير مخصص للإنتاج",
    security: "AES-256 · TLS 1.3 · مصادقة ثنائية · SOC 2 TYPE II",
    build: "جرين تشين © 2025 · الإصدار v4.12.3",
    networkHealth: "صحة الشبكة",
    allNominal: "جميع الأنظمة تعمل",
    terminateSession: "إنهاء الجلسة",
    authenticated: "تم التحقق",
    enterpriseDashboard: "لوحة التحكم",
    coreModules: "الوحدات الأساسية",
    intelligence: "الذكاء",
    system: "النظام",
    commerce: "التجارة",
    navDashboard: "مصفوفة القيادة",
    navCompliance: "مركز الامتثال",
    navOptimizer: "محسّن التكاليف",
    navSourcing: "شبكة التوريد",
    navReports: "تقارير الذكاء الاصطناعي",
    navCredits: "أسواق الكربون",
    navSettings: "الإعدادات",
    navExports: "تصدير التدقيق",
    moduleUnderConstruction: "الوحدة قيد الإنشاء",
    navigateTo:
      "انتقل إلى لوحة التحكم أو المحسّن أو شبكة التوريد أو التقارير أو أسواق الكربون",
    initTelemetry: "جارٍ تهيئة مصفوفة القياس...",
    mod1eyebrow: "الوحدة الأولى · مباشر",
    mod1title: "مصفوفة القياس عن بُعد",
    mod1meta: "آخر مزامنة: 14 يونيو 2026 · 09:42 UTC · 3 تحذيرات تسرب نشطة",
    kpi1label: "انبعاثات النطاق 1",
    kpi1val: "١٢٬٤٨٠",
    kpi1unit: "tCO₂e",
    kpi1sub: "▼ 8.2% مقارنة بالربع الماضي",
    kpi2label: "التزام ضريبة الكربون",
    kpi2val: "$284K",
    kpi2unit: "حتى الآن",
    kpi2sub: "▲ 12% — تحديث EU CBAM",
    kpi3label: "التسرب المالي المُحتجز",
    kpi3val: "$1.4M",
    kpi3unit: "تم الاسترداد",
    kpi3sub: "▲ 23% مقارنة بالشهر الماضي",
    kpi4label: "مخاطر الغرامات النشطة",
    kpi4val: "3",
    kpi4unit: "تعرضات",
    kpi4sub: "المكسيك · المملكة المتحدة · البرازيل",
    annualEmission: "سجل الانبعاثات السنوي",
    systemAlerts: "تنبيهات النظام",
    criticalAlerts: "3 حرجة",
    complianceStatus: "حالة الامتثال — خط أنابيب تنظيمي",
    activeItems: "5 نشطة",
    mod3eyebrow: "الوحدة الثالثة",
    mod3title: "محسّن استرداد التكاليف والتسربات",
    mod3meta:
      "مراقبة أرضية المصنع في الوقت الفعلي · 14 مستشعراً · آخر فحص: 40 ثانية",
    commodityIndex: "مؤشر تعادل أسعار السلع",
    greenCapital: "بوابة تمويل رأس المال الأخضر",
    pipeline: "$8.2M في خط الأنابيب",
    application: "التقديم",
    mod4eyebrow: "الوحدة الرابعة",
    mod4title: "شبكة التوريد المستدام والخدمات اللوجستية",
    mod4meta: "284 مورداً موثقاً · 12 مفاوضة عقد نشطة · شبكة مصنفة ECO",
    supplierMarket: "سوق الموردين — الموردون الموصى بهم",
    ecoVerified: "موثق بيئياً",
    penaltyPredictor: "متنبئ الغرامات — توقعات المخاطر",
    highRisk: "3 مخاطر عالية",
    requestQuote: "طلب عرض سعر",
    penaltyProb: "احتمالية الغرامة",
    supplier: "المورد",
    location: "الموقع",
    distance: "المسافة",
    ecoRating: "تصنيف ECO",
    unitPrice: "سعر الوحدة",
    scope1: "النطاق 1 — المباشر",
    scope2: "النطاق 2 — الطاقة",
    scope3: "النطاق 3 — سلسلة التوريد",
    avgDelivery: "متوسط مسافة التوصيل",
    avgCarbon: "متوسط تصنيف الكربون",
    activeRfq: "طلبات الأسعار النشطة",
    aiReportsEyebrow: "الوحدة الخامسة · مدعوم بالذكاء الاصطناعي",
    aiReportsTitle: "مولّد التقارير الذكي",
    aiReportsMeta: "Claude AI · تقارير ESG والامتثال الفورية · أكثر من 40 قالب",
    generateReport: "إنشاء تقرير",
    reportType: "نوع التقرير",
    selectTemplate: "اختر قالباً...",
    reportStatus: "جارٍ إنشاء التقرير...",
    reportDone: "التقرير جاهز",
    reportDownload: "تحميل PDF",
    aiAnalysis: "تحليل الذكاء الاصطناعي",
    reportPromptPh: "صف متطلبات تقريرك...",
    creditsEyebrow: "الوحدة السادسة",
    creditsTitle: "منصة تداول أرصدة الكربون",
    creditsMeta: "EU ETS · Gold Standard · VCS · CDM · أسعار السوق المباشرة",
    buyCredits: "شراء أرصدة",
    sellCredits: "بيع أرصدة",
    creditPrice: "سعر الرصيد",
    creditVol: "حجم 24 ساعة",
    yourPortfolio: "محفظتك",
    totalCredits: "إجمالي الأرصدة",
    portfolioVal: "قيمة المحفظة",
    offsetGoal: "هدف التعويض",
    pricingTitle: "خطط المؤسسات",
  ...
  fr: {
    appName: "GREENCHAIN",
    tagline: "Chaînes d'approvisionnement.",
    taglineGreen: "Décarbonées.",
    systemAccess: "Accès Système",
    gateway: "PASSERELLE ENTREPRISE ZÉRO-CONFIANCE",
    enterpriseId: "ID Entreprise",
    passkey: "Mot de passe",
    awaitHandshake: "En attente de la poignée de main...",
    initiateSession: "LANCER LA SESSION",
    authenticating: "AUTHENTIFICATION...",
    sso: "SSO via Azure AD / Okta / SAML 2.0",
    devBypass: "⚙ BYPASS DEV",
    devMode: "MODE DÉVELOPPEUR · PAS POUR LA PRODUCTION",
    security: "AES-256 · TLS 1.3 · MFA ACTIVÉ · SOC 2 TYPE II",
    build: "GreenChain AI © 2025 · Build v4.12.3",
    networkHealth: "État du Réseau",
    allNominal: "TOUS LES SYSTÈMES NOMINAUX",
    terminateSession: "TERMINER LA SESSION",
    authenticated: "AUTHENTIFIÉ",
    enterpriseDashboard: "Tableau de Bord",
    coreModules: "MODULES PRINCIPAUX",
    intelligence: "INTELLIGENCE",
    system: "SYSTÈME",
    commerce: "COMMERCE",
    navDashboard: "Matrice de Commande",
    navCompliance: "Centre Conformité",
    navOptimizer: "Optimiseur de Coûts",
    navSourcing: "Grille d'Approvisionnement",
    navReports: "Rapports IA",
    navCredits: "Crédits Carbone",
    navSettings: "Configuration",
    navExports: "Exports d'Audit",
    moduleUnderConstruction: "MODULE EN CONSTRUCTION",
    navigateTo:
      "Naviguez vers Tableau de Bord, Optimiseur, Grille, Rapports IA ou Crédits Carbone",
    initTelemetry: "Initialisation de la matrice de télémétrie...",
    mod1eyebrow: "Module I · En direct",
    mod1title: "Matrice de Télémétrie de Commande",
    mod1meta:
      "Dernière sync: 14 Jun 2026 · 09:42 UTC · 3 alertes de fuite actives",
    kpi1label: "Émissions Scope 1",
    kpi1val: "12 480",
    kpi1unit: "tCO₂e",
    kpi1sub: "▼ 8,2% vs trimestre passé",
    kpi2label: "Passif Taxe Carbone",
    kpi2val: "$284K",
    kpi2unit: "YTD",
    kpi2sub: "▲ 12% — Mise à jour EU CBAM",
    kpi3label: "Fuite de Coûts Détectée",
    kpi3val: "$1,4M",
    kpi3unit: "Récupéré",
    kpi3sub: "▲ 23% vs mois passé",
    kpi4label: "Risque de Pénalité Actif",
    kpi4val: "3",
    kpi4unit: "Expositions",
    kpi4sub: "Mexique · UK · Brésil",
    annualEmission: "Registre Annuel des Émissions",
    systemAlerts: "Alertes Système",
    criticalAlerts: "3 CRITIQUES",
    complianceStatus: "Statut de Conformité — Pipeline Réglementaire",
    activeItems: "5 ACTIFS",
    mod3eyebrow: "Module III",
    mod3title: "Optimiseur de Récupération de Coûts",
    mod3meta:
      "Surveillance en temps réel · 14 capteurs actifs · Dernier scan: il y a 40s",
    commodityIndex: "Indice de Parité des Prix des Matières Premières",
    greenCapital: "Passerelle de Financement Vert",
    pipeline: "PIPELINE DE $8,2M",
    application: "Candidature",
    mod4eyebrow: "Module IV",
    mod4title: "Grille d'Approvisionnement Durable",
    mod4meta:
      "284 fournisseurs vérifiés · 12 négociations actives · Réseau ECO-noté",
    supplierMarket: "Marché Fournisseurs — Vendeurs Recommandés",
    ecoVerified: "ECO-VÉRIFIÉ",
    penaltyPredictor: "Prédicteur de Pénalités — Prévision des Risques",
    highRisk: "3 RISQUE ÉLEVÉ",
    requestQuote: "Demander un Devis",
    penaltyProb: "PROBABILITÉ DE PÉNALITÉ",
    ...
    scope3: "Scope 3 — Chaîne d'approvisionnement",
    avgDelivery: "Distance Livraison Moy.",
    avgCarbon: "Note Carbone Moy.",
    activeRfq: "RFQs Actifs",
    aiReportsEyebrow: "Module V · Propulsé par IA",
    aiReportsTitle: "Générateur de Rapports Intelligent",
    aiReportsMeta:
      "Claude AI · Rapports ESG et conformité instantanés · 40+ modèles",
    generateReport: "GÉNÉRER UN RAPPORT",
    reportType: "Type de Rapport",
    selectTemplate: "Choisir un modèle...",
    reportStatus: "GÉNÉRATION EN COURS...",
    reportDone: "RAPPORT PRÊT",
    reportDownload: "Télécharger PDF",
    aiAnalysis: "Analyse IA",
    reportPromptPh: "Décrivez vos exigences de rapport...",
    creditsEyebrow: "Module VI",
    creditsTitle: "Bureau de Trading de Crédits Carbone",
    creditsMeta:
      "EU ETS · Gold Standard · VCS · CDM · Prix du marché en direct",
    buyCredits: "Acheter",
    sellCredits: "Vendre",
    creditPrice: "Prix du Crédit",
    creditVol: "Volume 24h",
    yourPortfolio: "Votre Portefeuille",
    totalCredits: "Total Crédits",
    portfolioVal: "Valeur du Portefeuille",
    offsetGoal: "Objectif de Compensation",
    pricingTitle: "Plans Entreprise",
    pricingSubtitle:
      "Tarification transparente pour toutes les tailles d'équipes",
  ...
  pt: {
    appName: "GREENCHAIN",
    tagline: "Cadeias de suprimento.",
    taglineGreen: "Descarbonizadas.",
    systemAccess: "Acesso ao Sistema",
    gateway: "GATEWAY EMPRESARIAL ZERO-CONFIANÇA",
    enterpriseId: "ID Empresarial",
    passkey: "Senha",
    awaitHandshake: "Aguardando handshake seguro...",
    initiateSession: "INICIAR SESSÃO",
    authenticating: "AUTENTICANDO...",
    sso: "SSO via Azure AD / Okta / SAML 2.0",
    devBypass: "⚙ BYPASS DEV",
    devMode: "MODO DESENVOLVEDOR · NÃO PARA PRODUÇÃO",
    security: "AES-256 · TLS 1.3 · MFA ATIVADO · SOC 2 TYPE II",
    build: "GreenChain AI © 2025 · Build v4.12.3",
    networkHealth: "Saúde da Rede",
    allNominal: "TODOS OS SISTEMAS NOMINAIS",
    terminateSession: "ENCERRAR SESSÃO",
    authenticated: "AUTENTICADO",
    enterpriseDashboard: "Painel Empresarial",
    coreModules: "MÓDULOS PRINCIPAIS",
    intelligence: "INTELIGÊNCIA",
    system: "SISTEMA",
    commerce: "COMÉRCIO",
    navDashboard: "Matriz de Comando",
    navCompliance: "Central de Conformidade",
    navOptimizer: "Otimizador de Custos",
    navSourcing: "Grade de Fornecimento",
    navReports: "Relatórios IA",
    navCredits: "Créditos de Carbono",
    navSettings: "Configurações",
    navExports: "Exportações de Auditoria",
    moduleUnderConstruction: "MÓDULO EM CONSTRUÇÃO",
    navigateTo:
      "Navegue para Painel, Otimizador, Grade, Relatórios IA ou Créditos de Carbono",
    initTelemetry: "Inicializando matriz de telemetria...",
    mod1eyebrow: "Módulo I · Ao Vivo",
    mod1title: "Matriz de Telemetria de Comando",
    mod1meta:
      "Última sincronização: 14 Jun 2026 · 09:42 UTC · 3 alertas de vazamento ativos",
    kpi1label: "Emissões Escopo 1",
    kpi1val: "12.480",
    kpi1unit: "tCO₂e",
    kpi1sub: "▼ 8,2% vs último trimestre",
    kpi2label: "Passivo Fiscal de Carbono",
    kpi2val: "$284K",
    kpi2unit: "No ano",
    kpi2sub: "▲ 12% — Atualização EU CBAM",
    kpi3label: "Vazamento Capturado",
    kpi3val: "$1,4M",
    kpi3unit: "Recuperado",
    kpi3sub: "▲ 23% vs mês passado",
    kpi4label: "Risco de Penalidade Ativo",
    kpi4val: "3",
    kpi4unit: "Exposições",
    kpi4sub: "México · UK · Brasil",
    annualEmission: "Registro Anual de Emissões",
    systemAlerts: "Alertas do Sistema",
    criticalAlerts: "3 CRÍTICOS",
    complianceStatus: "Status de Conformidade — Pipeline Regulatório",
    activeItems: "5 ATIVOS",
    mod3eyebrow: "Módulo III",
    mod3title: "Otimizador de Recuperação de Custos",
    mod3meta:
      "Monitoramento em tempo real · 14 sensores ativos · Último scan: 40s atrás",
    commodityIndex: "Índice de Paridade de Preço de Commodities",
    greenCapital: "Gateway de Financiamento Verde",
    pipeline: "PIPELINE DE $8,2M",
    application: "Candidatura",
    mod4eyebrow: "Módulo IV",
    mod4title: "Grade de Fornecimento Sustentável",
    mod4meta:
      "284 fornecedores verificados · 12 negociações ativas · Rede ECO-avaliada",
    supplierMarket: "Mercado de Fornecedores — Fornecedores Recomendados",
    ecoVerified: "ECO-VERIFICADO",
    penaltyPredictor: "Preditor de Penalidades — Previsão de Risco",
    highRisk: "3 ALTO RISCO",
    requestQuote: "Solicitar Cotação",
    penaltyProb: "PROBABILIDADE DE PENALIDADE",
    supplier: "Fornecedor",
    location: "Localização",
    distance: "Distância",
    ecoRating: "Avaliação ECO",
    unitPrice: "Preço Unitário",
    scope1: "Escopo 1 — Direto",
    scope2: "Escopo 2 — Energia",
    scope3: "Escopo 3 — Cadeia de Suprimento",
    avgDelivery: "Dist. Média de Entrega",
    avgCarbon: "Avaliação Média de Carbono",
    activeRfq: "RFQs Ativos",
    aiReportsEyebrow: "Módulo V · Powered by IA",
    aiReportsTitle: "Gerador Inteligente de Relatórios",
    aiReportsMeta:
      "Claude AI · Relatórios ESG e conformidade instantâneos · 40+ modelos",
    generateReport: "GERAR RELATÓRIO",
    reportType: "Tipo de Relatório",
    selectTemplate: "Selecionar modelo...",
    reportStatus: "GERANDO RELATÓRIO...",
    reportDone: "RELATÓRIO PRONTO",
    reportDownload: "Baixar PDF",
    aiAnalysis: "Análise de IA",
    reportPromptPh: "Descreva seus requisitos de relatório...",
    creditsEyebrow: "Módulo VI",
    creditsTitle: "Mesa de Negociação de Créditos de Carbono",
    creditsMeta:
      "EU ETS · Gold Standard · VCS · CDM · Preços de mercado ao vivo",
    buyCredits: "Comprar",
    sellCredits: "Vender",
    ...
    portfolioVal: "Valor do Portfólio",
    offsetGoal: "Meta de Compensação",
    pricingTitle: "Planos Empresariais",
  ...
  zh: {
    ...
    enterpriseId: "企业账号",
    passkey: "密码",
    awaitHandshake: "等待安全握手验证...",
    initiateSession: "启动会话",
    authenticating: "认证中...",
    sso: "通过 Azure AD / Okta / SAML 2.0 单点登录",
    devBypass: "⚙ 开发者通道",
    devMode: "开发者模式 · 不用于生产环境",
    security: "AES-256 · TLS 1.3 · 双重认证 · SOC 2 TYPE II",
    build: "GreenChain AI © 2025 · 版本 v4.12.3",
    networkHealth: "网络状态",
    allNominal: "所有系统运行正常",
    terminateSession: "终止会话",
    authenticated: "已认证",
    enterpriseDashboard: "企业控制台",
    coreModules: "核心模块",
    intelligence: "智能",
    system: "系统",
    commerce: "商务",
    ...
    kpi4unit: "风险敞口",
    kpi4sub: "墨西哥 · 英国 · 巴西",
    annualEmission: "年度排放登记",
    systemAlerts: "系统警报",
    criticalAlerts: "3 条严重警报",
    complianceStatus: "合规状态 — 监管管道",
    activeItems: "5 项活跃",
    mod3eyebrow: "模块三",
    mod3title: "成本回收与泄漏优化器",
    mod3meta: "工厂实时监控 · 14个活跃传感器 · 最后扫描：40秒前",
    commodityIndex: "大宗商品价格平价指数",
    greenCapital: "绿色资本融资网关",
    pipeline: "$8.2M 融资管道",
    application: "申请进度",
    mod4eyebrow: "模块四",
    mod4title: "可持续采购与物流网格",
    mod4meta: "284家认证供应商 · 12项合同谈判进行中 · ECO评级网络",
    supplierMarket: "供应商市场 — 推荐供应商",
    ecoVerified: "ECO认证",
    penaltyPredictor: "罚款预测器 — 监管风险预测",
    highRisk: "3 高风险",
    requestQuote: "申请报价",
    penaltyProb: "罚款概率",
    supplier: "供应商",
    ...
    avgCarbon: "平均碳评级",
    activeRfq: "活跃询价单",
    aiReportsEyebrow: "模块五 · AI驱动",
    aiReportsTitle: "智能报告生成器",
  ...
  ru: {
    appName: "GREENCHAIN",
    tagline: "Цепочки поставок.",
    taglineGreen: "Декарбонизированные.",
    systemAccess: "Доступ к системе",
    gateway: "КОРПОРАТИВНЫЙ ШЛЮЗ НУЛЕВОГО ДОВЕРИЯ",
    enterpriseId: "Корпоративный ID",
    passkey: "Пароль",
    awaitHandshake: "Ожидание безопасного рукопожатия...",
    initiateSession: "НАЧАТЬ СЕССИЮ",
    authenticating: "АУТЕНТИФИКАЦИЯ...",
    sso: "SSO через Azure AD / Okta / SAML 2.0",
    devBypass: "⚙ ОБХОД РАЗРАБОТЧИКА",
    devMode: "РЕЖИМ РАЗРАБОТЧИКА · НЕ ДЛЯ ПРОДАКШНА",
    security: "AES-256 · TLS 1.3 · MFA · SOC 2 TYPE II",
    build: "GreenChain AI © 2025 · Сборка v4.12.3",
    networkHealth: "Состояние сети",
    allNominal: "ВСЕ СИСТЕМЫ В НОРМЕ",
    terminateSession: "ЗАВЕРШИТЬ СЕССИЮ",
    authenticated: "АУТЕНТИФИЦИРОВАН",
    enterpriseDashboard: "Корпоративная Панель",
    coreModules: "ОСНОВНЫЕ МОДУЛИ",
    intelligence: "АНАЛИТИКА",
    system: "СИСТЕМА",
    commerce: "КОММЕРЦИЯ",
    navDashboard: "Командная матрица",
    navCompliance: "Центр соответствия",
    navOptimizer: "Оптимизатор затрат",
    navSourcing: "Сеть поставок",
    navReports: "Отчёты ИИ",
    navCredits: "Торговля углеродом",
    navSettings: "Конфигурация",
    navExports: "Экспорт аудита",
    moduleUnderConstruction: "МОДУЛЬ В РАЗРАБОТКЕ",
    navigateTo:
      "Перейдите в Панель, Оптимизатор, Сеть поставок, Отчёты ИИ или Торговлю углеродом",
    initTelemetry: "Инициализация матрицы телеметрии...",
    mod1eyebrow: "Модуль I · В реальном времени",
    mod1title: "Командная матрица телеметрии",
    mod1meta:
      "Последняя синхронизация: 14 июн 2026 · 09:42 UTC · 3 предупреждения об утечках",
    kpi1label: "Выбросы Scope 1",
    kpi1val: "12 480",
    kpi1unit: "tCO₂e",
    kpi1sub: "▼ 8,2% к прошлому кварталу",
    kpi2label: "Обязательства по налогу на CO₂",
    kpi2val: "$284K",
    kpi2unit: "ЗА ГОД",
    kpi2sub: "▲ 12% — Обновление EU CBAM",
    kpi3label: "Выявленные утечки затрат",
    kpi3val: "$1,4M",
    kpi3unit: "Возвращено",
    kpi3sub: "▲ 23% к прошлому месяцу",
    kpi4label: "Активный риск штрафов",
    kpi4val: "3",
    kpi4unit: "Позиции",
    kpi4sub: "Мексика · Великобритания · Бразилия",
    annualEmission: "Годовой реестр выбросов",
    systemAlerts: "Системные оповещения",
    criticalAlerts: "3 КРИТИЧЕСКИХ",
    complianceStatus: "Статус соответствия — Регуляторный конвейер",
    activeItems: "5 АКТИВНЫХ",
    mod3eyebrow: "Модуль III",
    mod3title: "Оптимизатор возврата затрат и утечек",
    mod3meta:
      "Мониторинг цеха в реальном времени · 14 датчиков · Последнее сканирование: 40с назад",
    commodityIndex: "Индекс ценового паритета сырьевых товаров",
    greenCapital: "Шлюз зелёного финансирования",
    pipeline: "КОНВЕЙЕР $8,2М",
    application: "Заявка",
    mod4eyebrow: "Модуль IV",
    mod4title: "Сеть устойчивых поставок и логистики",
    mod4meta:
      "284 верифицированных поставщика · 12 активных переговоров · Сеть с ECO-рейтингом",
    supplierMarket: "Торговая площадка поставщиков — Рекомендуемые",
    ecoVerified: "ECO-ВЕРИФИЦИРОВАНО",
    penaltyPredictor: "Предиктор штрафов — Прогноз регуляторного риска",
    highRisk: "3 ВЫСОКИЙ РИСК",
    requestQuote: "Запросить котировку",
    penaltyProb: "ВЕРОЯТНОСТЬ ШТРАФА",
    supplier: "Поставщик",
    location: "Локация",
    distance: "Расстояние",
    ecoRating: "ECO рейтинг",
    unitPrice: "Цена за ед.",
    scope1: "Scope 1 — Прямые",
    scope2: "Scope 2 — Энергия",
    scope3: "Scope 3 — Цепочка поставок",
    avgDelivery: "Ср. расстояние доставки",
    avgCarbon: "Ср. углеродный рейтинг",
    activeRfq: "Активных RFQ",
    aiReportsEyebrow: "Модуль V · На базе ИИ",
    aiReportsTitle: "Интеллектуальный генератор отчётов",
    aiReportsMeta:
      "Claude AI · Мгновенные ESG и отчёты о соответствии · 40+ шаблонов",
    generateReport: "СОЗДАТЬ ОТЧЁТ",
    reportType: "Тип отчёта",
    selectTemplate: "Выбрать шаблон...",
    reportStatus: "СОЗДАНИЕ ОТЧЁТА...",
    reportDone: "ОТЧЁТ ГОТОВ",
    reportDownload: "Скачать PDF",
    aiAnalysis: "Анализ ИИ",
    reportPromptPh: "Опишите требования к отчёту...",
    creditsEyebrow: "Модуль VI",
    creditsTitle: "Торговый стол углеродными кредитами",
    creditsMeta:
      "EU ETS · Gold Standard · VCS · CDM · Цены рынка в реальном времени",
    buyCredits: "Купить",
    sellCredits: "Продать",
    creditPrice: "Цена кредита",
    creditVol: "Объём за 24ч",
    yourPortfolio: "Ваш портфель",
    totalCredits: "Всего кредитов",
    portfolioVal: "Стоимость портфеля",
    offsetGoal: "Цель компенсации",
    pricingTitle: "Корпоративные тарифы",
    pricingSubtitle: "Прозрачные цены для команд любого размера",
    planStarter: "Стартовый",
    planGrowth: "Рост",
    planEnterprise: "Корпоративный",
    planCustom: "Индивидуальный",
    perMonth: "/мес",
    getStarted: "Начать",
  ...
  de: {
    appName: "GREENCHAIN",
    tagline: "Lieferketten.",
    taglineGreen: "Dekarbonisiert.",
    systemAccess: "Systemzugang",
    gateway: "ZERO-TRUST UNTERNEHMENS-GATEWAY",
    enterpriseId: "Unternehmens-ID",
    passkey: "Passwort",
    awaitHandshake: "Warte auf sicheren Handshake...",
    initiateSession: "SITZUNG STARTEN",
    authenticating: "AUTHENTIFIZIERUNG...",
    sso: "SSO über Azure AD / Okta / SAML 2.0",
    devBypass: "⚙ ENTWICKLER-BYPASS",
    devMode: "ENTWICKLERMODUS · NICHT FÜR PRODUKTION",
    security: "AES-256 · TLS 1.3 · MFA · SOC 2 TYPE II",
    build: "GreenChain AI © 2025 · Build v4.12.3",
    networkHealth: "Netzwerkstatus",
    allNominal: "ALLE SYSTEME NOMINAL",
    terminateSession: "SITZUNG BEENDEN",
    authenticated: "AUTHENTIFIZIERT",
    enterpriseDashboard: "Unternehmens-Dashboard",
    coreModules: "KERNMODULE",
    intelligence: "INTELLIGENZ",
    system: "SYSTEM",
    commerce: "HANDEL",
    navDashboard: "Befehlsmatrix",
    navCompliance: "Compliance-Kern",
    navOptimizer: "Kostenoptimierer",
    navSourcing: "Beschaffungsraster",
    navReports: "KI-Berichte",
    navCredits: "CO₂-Handel",
    navSettings: "Konfiguration",
    navExports: "Audit-Exporte",
    moduleUnderConstruction: "MODUL IN ENTWICKLUNG",
    navigateTo:
      "Navigieren Sie zu Dashboard, Optimierer, Beschaffung, KI-Berichte oder CO₂-Handel",
    initTelemetry: "Telemetrie-Matrix wird initialisiert...",
    mod1eyebrow: "Modul I · Live",
    mod1title: "Befehls-Telemetrie-Matrix",
    mod1meta: "Letzte Sync: 14. Jun 2026 · 09:42 UTC · 3 aktive Leckwarnungen",
    kpi1label: "Scope-1-Emissionen",
    kpi1val: "12.480",
    kpi1unit: "tCO₂e",
    kpi1sub: "▼ 8,2% ggü. letztem Quartal",
    kpi2label: "CO₂-Steuerverbindlichkeit",
    kpi2val: "$284K",
    kpi2unit: "YTD",
    kpi2sub: "▲ 12% — EU-CBAM-Update",
    kpi3label: "Erfasste Kostenlecks",
    kpi3val: "$1,4M",
    kpi3unit: "Zurückgewonnen",
    kpi3sub: "▲ 23% ggü. letztem Monat",
    kpi4label: "Aktives Strafrisiko",
    kpi4val: "3",
    kpi4unit: "Expositionen",
    kpi4sub: "Mexiko · UK · Brasilien",
    annualEmission: "Jährliches Emissionsregister",
    systemAlerts: "Systemwarnungen",
    criticalAlerts: "3 KRITISCH",
    complianceStatus: "Compliance-Status — Regulatorische Pipeline",
    activeItems: "5 AKTIV",
    mod3eyebrow: "Modul III",
    mod3title: "Kostenrückgewinnung & Leck-Optimierer",
    mod3meta:
      "Echtzeit-Fabriküberwachung · 14 aktive Sensoren · Letzter Scan: vor 40s",
    commodityIndex: "Rohstoffpreisparitäts-Index",
    greenCapital: "Green-Capital-Finanzierungs-Gateway",
    pipeline: "$8,2M PIPELINE",
    application: "Bewerbung",
    mod4eyebrow: "Modul IV",
    mod4title: "Nachhaltiges Beschaffungs- & Logistikraster",
    mod4meta:
      "284 verifizierte Lieferanten · 12 aktive Verhandlungen · ECO-bewertetes Netzwerk",
    supplierMarket: "Lieferantenmarktplatz — Empfohlene Anbieter",
    ecoVerified: "ECO-VERIFIZIERT",
    penaltyPredictor: "Strafprognose — Regulatorische Risikoprognose",
    highRisk: "3 HOHES RISIKO",
    requestQuote: "Angebot anfordern",
    penaltyProb: "STRAFWAHRSCHEINLICHKEIT",
    supplier: "Lieferant",
    location: "Standort",
    distance: "Entfernung",
    ecoRating: "ECO-Bewertung",
    unitPrice: "Stückpreis",
    scope1: "Scope 1 — Direkt",
    scope2: "Scope 2 — Energie",
    scope3: "Scope 3 — Lieferkette",
    avgDelivery: "Ø Lieferentfernung",
    avgCarbon: "Ø Carbon-Bewertung",
    activeRfq: "Aktive Anfragen",
    aiReportsEyebrow: "Modul V · KI-gestützt",
    aiReportsTitle: "Intelligenter Berichtsgenerator",
    aiReportsMeta:
      "Claude AI · Sofortige ESG- und Compliance-Berichte · 40+ Vorlagen",
    generateReport: "BERICHT ERSTELLEN",
    reportType: "Berichtstyp",
    selectTemplate: "Vorlage auswählen...",
    reportStatus: "BERICHT WIRD ERSTELLT...",
    reportDone: "BERICHT BEREIT",
    reportDownload: "PDF herunterladen",
    aiAnalysis: "KI-Analyse",
    reportPromptPh: "Beschreiben Sie Ihre Berichtsanforderungen...",
    creditsEyebrow: "Modul VI",
    creditsTitle: "CO₂-Zertifikate Handelsplatz",
    creditsMeta: "EU ETS · Gold Standard · VCS · CDM · Live-Marktpreise",
    buyCredits: "Kaufen",
    sellCredits: "Verkaufen",
    creditPrice: "Kreditpreis",
    creditVol: "24h-Volumen",
    yourPortfolio: "Ihr Portfolio",
    totalCredits: "Gesamt-Zertifikate",
    portfolioVal: "Portfoliowert",
    offsetGoal: "Ausgleichsziel",
    pricingTitle: "Unternehmenspläne",
...
const ALERTS = [
  {
    type: "crit",
    icon: "⚡",
    msg: "Line 4 energy draw exceeded threshold by 34%",
    time: "2 MIN AGO",
  },
  {
    type: "warn",
    icon: "⚠",
    msg: "Carbon tax rate updated: EU CBAM +12% effective Q1 2027",
    time: "18 MIN AGO",
  },
  {
    type: "ok",
    icon: "✓",
    msg: "Scope 2 Q3 audit export certified & submitted",
    time: "1 HR AGO",
  },
  {
    type: "warn",
    icon: "⚠",
    msg: "Steel supplier ECO-57 rating downgraded to B",
    time: "3 HR AGO",
  },
  {
    type: "ok",
    icon: "✓",
    msg: "Green Capital Grant #GC-2024-081 pre-approved",
    time: "5 HR AGO",
  },
];
const SUPPLIERS = [
...
const GRANTS = [
  {
    name: "EU Green Industrial Fund",
    org: "European Commission",
    amt: "€2.4M",
    pct: 78,
  },
  {
    name: "IFC Climate Finance",
  ...
  {
    name: "DOE Industrial Decarbonization",
...
const TL_ITEMS = [
  {
    state: "done",
    label: "CBAM Phase 1 Filing",
    desc: "Submitted 14 Oct 2025 — Ref #EU-CBM-20251014",
  },
  {
    state: "done",
    label: "ISO 14064-1 Audit",
    desc: "Verified by Bureau Veritas, valid 24 months",
  },
  {
    state: "pend",
    label: "SEC Climate Disclosure",
    desc: "Deadline: 31 Mar 2027 — 68% complete",
  },
  {
    state: "alert",
    label: "Mexico ECOTASA Update",
    desc: "New tariff schedule unprocessed — action required",
  },
  {
    state: "pend",
    label: "UK Streamlined Energy",
    desc: "Annual SECR report due 31 Dec 2026",
  },
];
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      nodes.forEach((n) => {
        ...
        ctx.fillStyle = `rgba(0,255,136,${n.r / 4})`;
        ctx.fill();
      });
      for (let i = 0; i < nodes.length; i++)
        for (let j = i + 1; j < nodes.length; j++) {
          ...
          if (d < 150) {
            ...
            ctx.strokeStyle = `rgba(0,255,136,${(1 - d / 150) * 0.35})`;
            ctx.lineWidth = 0.6;
            ctx.stroke();
          }
        }
...
function Sparkline({ up }) {
  ...
  const W = 56,
    H = 22,
    xs = pts.map((_, i) => (i / (pts.length - 1)) * W);
  const mn = Math.min(...pts),
    mx = Math.max(...pts);
  const ys = pts.map((v) => H - ((v - mn) / (mx - mn + 0.01)) * (H - 4) - 2);
  const d = xs.map((x, i) => `${i === 0 ? "M" : "L"}${x},${ys[i]}`).join(" ");
  return (
    <svg viewBox={`0 0 ${W} ${H}`} className="gc-sparkline">
      <path d={d} stroke={up ? T.green : T.red} strokeWidth="1.5" fill="none" />
    </svg>
  );
}
      ...
      {open && (
        <div className="lang-dropdown">
          {LANGS.map((l) => (
            <div
              key={l.code}
              className={`lang-opt${lang === l.code ? " sel" : ""}`}
              onClick={() => {
                setLang(l.code);
                setOpen(false);
              }}
            >
              ...
              {lang === l.code && (
                <span
                  style={{ marginLeft: "auto", color: T.green, fontSize: 9 }}
                >
                  ✓
                </span>
              )}
    ...
    <div className="gc-login" dir={rtl ? "rtl" : "ltr"}>
      <div className="gc-login-void">
        ...
        <div className="gc-login-tagline">
          <div className="gc-login-eyebrow">
            // INDUSTRIAL CLIMATE INTELLIGENCE PLATFORM
          </div>
      ...
      <div className="gc-login-col">
        ...
        <div className="gc-token-display">
          {loading ? (
            <>
              {token}
              <span className="gc-token-cursor" />
            </>
          ) : (
            <span style={{ color: T.textMute }}>{t.awaitHandshake}</span>
          )}
        </div>
        <button
          className="gc-btn"
        ...
        <div
          style={{
            marginTop: 10,
            borderTop: `1px dashed ${T.textMute}33`,
            paddingTop: 10,
          }}
        >
          <button className="gc-btn gc-btn-dev" onClick={() => onLogin()}>
            {t.devBypass}
          </button>
          <div
            style={{
        ...
        <div className="gc-login-footer">
          {t.security}
          <br />
          <span style={{ color: T.textMute, opacity: 0.5 }}>{t.build}</span>
        </div>
      </div>
    </div>
  );
            ...
            <div className="gc-chart-bars">
              {EMISSION_DATA.map((d, i) => (
                <div key={i} className="gc-bar-wrap">
                  <div
                    className={`gc-bar ${i > 9 ? "" : "dim"}`}
                    style={{ height: `${(d.v / MAX_E) * 84}px` }}
                    data-val={`${d.v}k tCO₂e`}
                  />
        ...
        {[
          {
            ...
            val: "3",
            sub: "Line 4 · Furnace B · Compressor 7",
            color: T.red,
          },
          {
            icon: "💧",
            label: "Waste Spikes",
            val: "1",
            sub: "Coolant leak — Est. $4,200/day",
            color: T.amber,
          },
          {
            icon: "💰",
          ...
          {
            icon: "🌿",
            label: "Price Parity Items",
            val: "7",
            sub: "Low-emission materials at par",
            color: T.green,
          },
          {
            icon: "📋",
            ...
            val: "4",
            sub: "Active — $8.2M in pipeline",
            color: T.teal,
          },
          {
            icon: "🔔",
            label: "Penalty Forecasts",
            val: "3",
            sub: "High confidence — next 90 days",
            color: T.red,
          },
        ].map((c, i) => (
          <div key={i} className="gc-opt-card">
            ...
            <div className="gc-opt-val" style={{ color: c.color }}>
              {c.val}
            </div>
          ...
          <div className="gc-panel-body" style={{ padding: "8px 16px" }}>
            {COMMODITIES.map((c, i) => (
              <div key={i} className="gc-mkt-row">
                ...
                <div
                  className={`gc-mkt-change ${c.up ? "gc-green" : "gc-red"}`}
                >
                  {c.change}
                </div>
              </div>
    ...
    <>
        ...
        {[
          {
            label: t.avgDelivery,
            val: "972 km",
            sub: "▼ 14% vs conventional",
            color: "green",
          },
          {
            label: t.avgCarbon,
            val: "A–",
            sub: "Top 18% of global network",
            color: "green",
          },
          {
            label: t.activeRfq,
            val: "12",
            sub: "Est. $4.2M contract value",
            color: "",
          },
        ].map((k, i) => (
          <div key={i} className="gc-kpi">
            <div className="gc-kpi-label">{k.label}</div>
            <div className={`gc-kpi-value ${k.color}`}>{k.val}</div>
            <div className="gc-kpi-sub" style={{ marginTop: 6 }}>
              {k.sub}
            </div>
          </div>
        ))}
            ...
            <tbody>
              {SUPPLIERS.map((s, i) => (
                <tr key={i}>
                  ...
                  <td style={{ fontFamily: T.fontMono, fontSize: 10 }}>
                    {s.loc}
                  </td>
                  <td style={{ fontFamily: T.fontMono, fontSize: 10 }}>
                    {s.dist}
                  ...
                  <td>
                    <span className={`gc-eco-badge ${s.eco}`}>{s.eco}</span>
                  </td>
                  <td style={{ fontFamily: T.fontMono, color: T.textPri }}>
                    {s.price}
                  </td>
                  <td>
                    <button className="gc-vendor-action">
                      {t.requestQuote}
                    </button>
                  </td>
                </tr>
      ...
      <div className="gc-panel">
        ...
        <div className="gc-panel-body">
          {[
            {
              region: "Mexico — ECOTASA",
              risk: 92,
              est: "$180,000",
              deadline: "15 Jul 2026",
            },
            {
              region: "UK — SECR Non-filing",
              risk: 74,
              est: "$65,000",
              deadline: "31 Dec 2026",
            },
            {
              region: "Brazil — REDD+ Offset",
              risk: 61,
              est: "$290,000",
            ...
            <div key={i} style={{ marginBottom: 16 }}>
              ...
              >
                ...
                <span
                  style={{ fontFamily: T.fontMono, fontSize: 9, color: T.red }}
                >
                  Est. {r.est} · Due {r.deadline}
                </span>
              </div>
              <div className="gc-progress-track">
                <div
                  style={{
                    ...
                    width: `${r.risk}%`,
                    background:
                      r.risk > 80 ? T.red : r.risk > 60 ? T.amber : T.green,
                    transition: "width .9s",
                  }}
                />
              </div>
...
Use professional corporate language. Include specific numbers where relevant. Keep it to 250-300 words.`,
      ...
      setOutput(
        "Error connecting to AI engine. Please check your network connection.",
      );
      setStatus("done");
    }
  }
    ...
    <>
        ...
        <div className="gc-panel-body">
          <div className="gc-template-grid">
            {REPORT_TEMPLATES.map((r, i) => (
              <div
                key={i}
                className={`gc-template-card${selected === i ? " sel" : ""}`}
      ...
      {(status === "loading" || status === "done") && (
        <div className="gc-panel">
          ...
          <div className="gc-panel-body">
            <div
              className={`gc-ai-output${status === "loading" ? " loading" : ""}`}
            >
              {status === "loading" ? (
      ...
      <div className="gc-grid-2">
          ...
          <div className="gc-panel-body" style={{ padding: "8px 16px" }}>
            {CARBON_MARKETS.map((m, i) => (
              <div key={i} className="gc-mkt-row">
                ...
                <div
                  className={`gc-mkt-change ${m.up ? "gc-green" : "gc-red"}`}
                >
                  {m.change}
                </div>
              </div>
        ...
        <div className="gc-panel">
          <div className="gc-panel-header">
            ...
            <span
              className="gc-panel-badge"
              style={{ color: T.teal, borderColor: T.teal + "44" }}
            >
              EU ETS ACTIVE
            </span>
          </div>
        ...
        <div className="gc-panel-body">
          <div className="gc-pricing-grid">
            {PLANS.map((plan, i) => (
              <div
                key={i}
                className={`gc-plan${plan.popular ? " popular" : ""}`}
              >
                {plan.popular && (
                  <div className="gc-plan-popular-badge">
                    {t.mostPopular}
                  </div>
                )}
                ...
                {!plan.noPrice && (
                  <div className="gc-plan-period">{t.perMonth}</div>
                )}
                <div className="gc-plan-divider" />
                {plan.features.map((f, j) => (
                  <div key={j} className="gc-plan-feature">
                    {f}
                  </div>
                ))}
        ...
        <div className="gc-sidebar">
          ...
          <div className="gc-logo">
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div className="gc-logo-hex">
                <div className="gc-logo-hex-inner">GC</div>
              </div>
              <div>
          ...
          <div className="gc-sidebar-footer">
            ...
            <div className="gc-logout" onClick={onLogout}>
              {t.terminateSession}
            </div>
          </div>
        </div>
        <div className="gc-main">
          <div className="gc-topbar">
            ...
            <div className="gc-topbar-right">
              ...
              <div className="gc-icon-btn" title="Settings">
                ⚙
              </div>
          ...
          <div className="gc-content">{renderPage()}</div>
        </div>
      </div>
    </LangCtx.Provider>
  );
